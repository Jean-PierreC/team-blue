...
cv2.createTrackbar('hue', 'Control Panel',68,180,nothing)#default 0 205 255 69 $
...
def trackRectangle(mask, frame):
    ...
    if len(cnts) > 0:
        ...
        if M['m00'] > 0:
            ...
            #to have rectangle follow x and y center points we add the width an$
            ...
            #   angleCalculate = np.arctan(rectHeight/rectWidth)*360/(2*3.14159$
            # else:
            #   angleCalculate = 0
